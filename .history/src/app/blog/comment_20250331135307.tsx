  ...
  return (
    ...
    >
      <Flex gap={8}>
        ...
        >
          <BiLike size={20} />
          <Text fontSize="sm" fontWeight="medium">Thích</Text>
        </Flex>
        ...
        >
          <BiComment size={20} />
          <Text fontSize="sm" fontWeight="medium">Bình luận</Text>
        </Flex>
        ...
        >
          <BiSend size={20} />
          <Text fontSize="sm" fontWeight="medium">Gửi</Text>
        </Flex>
      </Flex>
      ...
      >
        <BiShare size={20} />
        <Text fontSize="sm" fontWeight="medium">Chia sẻ</Text>
      </Flex>
    </Flex>
  );
};

...
export default function SplitWithImage({session3}:{session3:Navbar}) {
  return (
    <Container bg={}  maxW={'7xl'} py={12}>
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10} bg={useColorModeValue("gray.100", "gray.800")}>
        <Stack spacing={4}>
          <Text
          ...
          <Text color={'gray.500'} fontSize={'lg'}>
            Trải nghiệm văn hóa phong phú, cảnh quan thiên nhiên tuyệt đẹp và ẩm thực đặc sắc tại mọi miền đất nước
          </Text>
          <Stack
            spacing={4}
            divider={
